...
-- Last modification date: 2024-04-09 10:03:46.241
...
ALTER TABLE club ADD CONSTRAINT club_city
    FOREIGN KEY (city_id)
        REFERENCES city (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE club ADD CONSTRAINT club_league
...
ALTER TABLE country ADD CONSTRAINT country_confederation
...
ALTER TABLE country_flag ADD CONSTRAINT flag_country
...
ALTER TABLE game ADD CONSTRAINT game_club_home
...
ALTER TABLE league ADD CONSTRAINT league_country
    FOREIGN KEY (country_id)
        REFERENCES country (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE next_game ADD CONSTRAINT next_game_game
    FOREIGN KEY (game_id)
        REFERENCES game (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE next_game ADD CONSTRAINT next_game_player
...
ALTER TABLE observation_position ADD CONSTRAINT observation_position_player_observation
...
ALTER TABLE observation_position ADD CONSTRAINT observation_position_position
...
ALTER TABLE player ADD CONSTRAINT player_club
    FOREIGN KEY (club_id)
        REFERENCES club (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE player_details ADD CONSTRAINT player_data_player
    FOREIGN KEY (player_id)
        REFERENCES player (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE player_observation ADD CONSTRAINT player_observation_game
    FOREIGN KEY (game_id)
        REFERENCES game (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE player_observation ADD CONSTRAINT player_observation_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE player_observation ADD CONSTRAINT player_statistics_player
    FOREIGN KEY (player_id)
        REFERENCES player (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
